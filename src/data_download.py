...
if __name__ == '__main__':
    ...
    download_data(save_root_path.joinpath(bucket_str), s3.Bucket(bucket_str), prefix='owlinone')
    download_data(save_root_path.joinpath(bucket_str), s3.Bucket(bucket_str), prefix='omsignal')
